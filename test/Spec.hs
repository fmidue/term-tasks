...
main = hspec $ do
  ...
  prop "Eyery term that generated by invalidTerms is invalid (signature1)" $
    forAll (invalidTerms signature1 [(3,ONEMORE),(2,TYPE)] 1 20 >>= elements) (\x -> not (all (isValid signature1) x)||null x)
  prop "Eyery term that generated by invalidTerms is invalid (signature2)" $
    forAll (invalidTerms signature2 [(2,ONELESS),(2,SYMBOLTYPE)] 1 10 >>= elements) (\x -> not (all (isValid signature2) x)||null x)
  prop "Eyery term that generated by invalidTerms is invalid (signature3)" $
    forAll (invalidTerms signature3 [(1,SYMBOL),(3,SYMBOLTYPE)] 1 10 >>= elements) (\x -> not (all (isValid signature3) x)||null x)
  prop "Eyery term that generated by invalidTerms is invalid (signature4)" $
    forAll (invalidTerms signature4 [(1,TYPE),(1,ONELESS)] 1 10 >>= elements) (\x -> not (all (isValid signature4) x)||null x)
  prop "Eyery term that generated by invalidTerms is invalid (signature5)" $
    forAll (invalidTerms signature5 [(2,TYPE)] 1 10 >>= elements) (\x -> not (all (isValid signature5) x)||null x)
  prop "Eyery term that generated by invalidTerms is invalid (signature6)" $
    forAll (invalidTerms signature6 [(3,SYMBOL),(3,SWAP)] 1 10 >>= elements) (\x -> not (all (isValid signature6) x)||null x)
