...
main = hspec $ do
  ...
  prop "Every term that generated by invalidTerms is invalid (signature1)" $
    forAll (invalidTerms signature1 1 20 Nothing [(3,OneMore), (2,TypeChange)] >>= elements) $ noneValid signature1
  prop "Every term that generated by invalidTerms is invalid (signature2)" $
    forAll (invalidTerms signature2 1 10 Nothing [(2,OneLess), (2,UnknownSymbol)] >>= elements) $ noneValid signature2
  prop "Every term that generated by invalidTerms is invalid (signature3)" $
    forAll (invalidTerms signature3 1 10 Nothing [(1,NameTypo), (3,UnknownSymbol)] >>= elements) $ noneValid signature3
  prop "Every term that generated by invalidTerms is invalid (signature4)" $
    forAll (invalidTerms signature4 1 10 Nothing [(1,TypeChange), (1,OneLess)] >>= elements) $ noneValid signature4
  prop "Every term that generated by invalidTerms is invalid (signature5)" $
    forAll (invalidTerms signature5 1 10 Nothing [(2,TypeChange)] >>= elements) $ noneValid signature5
  prop "Every term that generated by invalidTerms is invalid (signature6)" $
    forAll (invalidTerms signature6 1 10 Nothing [(3,NameTypo), (3,Swap)] >>= elements) $ noneValid signature6
...
noneValid :: Signature -> [Term String] -> Bool
noneValid signature = not . any (isValid signature)
