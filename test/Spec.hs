...
main = hspec $ do
  ...
  prop "Eyery term that generated by oneInvalidTerm is invalid (signature1)" $
    forAll (oneInvalidTerm signature1 ONEMORE 1 20) (not.isValid signature1)
  prop "Eyery term that generated by oneInvalidTerm is invalid (signature2)" $
    forAll (oneInvalidTerm signature2 ONELESS 1 8) (not.isValid signature2)
  prop "Eyery term that generated by oneInvalidTerm is invalid (signature3)" $
    forAll (oneInvalidTerm signature3 DUPLICATE 1 10) (not.isValid signature3)
  prop "Eyery term that generated by oneInvalidTerm is invalid (signature4)" $
    forAll (oneInvalidTerm signature4 SWAP 1 10) (not.isValid signature4)
  prop "Eyery term that generated by oneInvalidTerm is invalid (signature5)" $
    forAll (oneInvalidTerm signature5 TYPE 1 8) (not.isValid signature5)
  prop "Eyery term that generated by oneInvalidTerm is invalid (signature6)" $
    forAll (oneInvalidTerm signature6 SWAP 1 4) (not.isValid signature6)

  prop "Eyery term that generated by invalidTerms is invalid (signature1)" $
    forAll (invalidTerms signature1 [(1,ONEMORE),(2,TYPE)] 1 20 >>= elements) (not.isValid signature1)
  prop "Eyery term that generated by invalidTerms is invalid (signature2)" $
    forAll (invalidTerms signature2 [(1,ONELESS)] 1 10 >>= elements) (not.isValid signature2)
  prop "Eyery term that generated by invalidTerms is invalid (signature3)" $
    forAll (invalidTerms signature3 [(1,DUPLICATE)] 1 10 >>= elements) (not.isValid signature3)
  prop "Eyery term that generated by invalidTerms is invalid (signature4)" $
    forAll (invalidTerms signature4 [(1,TYPE),(1,ONELESS)] 1 10 >>= elements) (not.isValid signature4)
  prop "Eyery term that generated by invalidTerms is invalid (signature5)" $
    forAll (invalidTerms signature5 [(2,TYPE)] 1 10 >>= elements) (not.isValid signature5)
  prop "Eyery term that generated by invalidTerms is invalid (signature6)" $
    forAll (invalidTerms signature6 [(1,DUPLICATE),(1,SWAP)] 1 10 >>= elements) (not.isValid signature6)
